...
const bypassOtpEmails = {
  ...
  "manojgowda@skoegle.com": false,
  "manojgowdabr89@gmail.com": false
};
...
export default function Login() {
  ...
  return (
    ...
    <>
      {/* Checkbox Section */}
     { !sessionStorage.getItem("termsAccepted") && <Box sx={{ display: "flex", alignItems: "center", justifyContent: "flex-start" }}>
        <Checkbox
